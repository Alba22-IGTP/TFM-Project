...
if ("sample 12" %in% colnames(expression_matrix)) {
...
# Reemplazar rownames por los símbolos
...
# --- Filtrar genes con expresión > 1 en al menos una muestra de ambos datasets ---
...
# --- Gráficos de dispersión con jitter para evitar acumulación ---
library(ggrepel)
