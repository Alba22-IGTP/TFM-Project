...
2. Representación de la expresión génica (mediante heatmap) de las muestras finales tras normalizar: Heatmap_After_SF.Rmd
3. Datos clínicos de las muestras: Caracteristicas_clin.Rmd
4. Análisis de exprsión diferencial: DE_Analysis_Limma.Rmd
5. Validación externa con 2 bases de datos (1 por cada tratamiento) de RNASeq: Validación_BBDD.Rmd
6. Análisis no supervisado: ML.Rmd
